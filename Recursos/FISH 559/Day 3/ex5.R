...
setwd("D:\\courses\\FISH 559_20\\TMB Workshop\\In Class Assignments\\Ex5")
require(TMB)
...
model <- MakeADFun(data, parameters, random="eta", DLL="Ex5",silent=T,map=map)
